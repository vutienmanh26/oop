...
public class StringCodeTest {
	...
	public void testStringIntersect_1(){
        assertEquals(true, StringCode.stringIntersect("aaab","baaa",3));
        assertEquals(true, StringCode.stringIntersect("aaabbbbbcc","baanjcwjehc",2));
        assertEquals(false, StringCode.stringIntersect("aab","baaa",3));
